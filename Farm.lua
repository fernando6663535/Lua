...
local function CreatePlayerButton(player, index)
    ...
    local rankText = icons[index] or tostring(index)  -- Usar íconos o número de puesto
...
local function onCharacterAdded(character)
    -- Conectar eventos de cambio relevantes para actualizar dinámicamente
    character:WaitForChild("Humanoid").Died:Connect(function()
        updateNumbers()  -- Actualizar números cuando el jugador muere
    end)

    -- Ejemplo de escucha de cambio en una propiedad específica
    ...
    if strengthLabel then
        strengthLabel:GetPropertyChangedSignal("Text"):Connect(function()
            updateNumbers()  -- Actualizar números cuando cambia la fuerza
        end)
    end
end
